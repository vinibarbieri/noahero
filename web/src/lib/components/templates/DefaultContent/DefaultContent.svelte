<script lang="ts">
  // Este componente é exibido quando nenhuma empresa está selecionada
</script>

<div class="h-full flex items-center justify-center bg-primary-50">
  <div class="text-center p-8 bg-white rounded-xl shadow-lg max-w-md">
    <h1 class="text-2xl font-bold mb-4 text-primary-800">Bem-vindo ao App!</h1>
